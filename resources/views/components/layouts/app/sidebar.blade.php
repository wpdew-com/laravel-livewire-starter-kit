        ...
        <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900" style="z-index: 1;">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group heading="{{__('Settings')}}" class="grid">
                    <flux:navlist.item icon="document" :href="route('dashboard')" :current="request()->routeIs('dashboard')" wire:navigate>{{ __('Pages') }}</flux:navlist.item>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item icon="folder-git-2" href="https://github.com/wpdew-com/laravel-livewire-starter-kit" target="_blank">
                {{ __('Repository') }}
                </flux:navlist.item>
